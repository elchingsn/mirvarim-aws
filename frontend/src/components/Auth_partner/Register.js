  ...
  return (
    <div className={classes.root}>
            ...
            return (
              ...
              >
                <FormControl margin="dense" required fullWidth>
                  <FormHelperText style={{textAlign: "center"}}>{t("Register as Salon or Master")}</FormHelperText>
                  <Box
                    mt={1}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>{t("Partner account successfully created!")}</DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
            color="primary"
