...
const UpdateSalon = ({classes}) => {
    ...
    const [hairCategories, setHairCategories] = useState(data_salon.hairCategories.map(item => item.title).flat(1));
    const [nailsCategories, setNailsCategories] = useState(data_salon.nailsCategories.map(item => item.id).flat(1));
    console.log(nailsCategories)
    const [hairRemovalCategories, setHairRemovalCategories] = useState(data_salon.hairRemovalCategories.map(item => item.title).flat(1));
    const [makeupCategories, setMakeupCategories] = useState(data_salon.makeupCategories.map(item => item.title).flat(1));
    const [massageCategories, setMassageCategories] = useState(data_salon.massageCategories.map(item => item.title).flat(1));
    const [cosmetologyCategories, setCosmetologyCategories] = useState(data_salon.cosmetologyCategories.map(item => item.title).flat(1));
    const [eyebrowCategories, setEyebrowCategories] = useState(data_salon.eyebrowCategories.map(item => item.title).flat(1));
    const [tattooCategories, setTattooCategories] = useState(data_salon.tattooCategories.map(item => item.title).flat(1));
    const [aestheticsCategories, setAestheticsCategories] = useState(data_salon.aestheticsCategories.map(item => item.title).flat(1));
        ...
        <Paper className={classes.paper}>
            ...
            >
              ...
              if (error) return <Error error={error} />;
                return(
                  <form onSubmit={event => handleSubmit(event, updateSalon)} noValidate>
                  ...
                  <FormControl fullWidth className={classes.field}>
                    <Query query={HAIR_REMOVAL_QUERY} className={classes.field}>
                      ...
                      return  <Autocomplete
                                ...
                                size="small"
                                options={categories}
                                defaultValue={hairRemovalCategories}
                                onChange={(event,value) => {
                  ...
                  <FormControl fullWidth className={classes.field}>
                    <Query query={MASSAGE_QUERY} className={classes.field}>
                      ...
                      return  <Autocomplete
                                ...
                                size="small"
                                options={categories}
                                defaultValue={massageCategories}
                                onChange={(event,value) => {
                  ...
                  <FormControl fullWidth className={classes.field}>
                    <Query query={EYEBROW_QUERY} className={classes.field}>
                      ...
                      return  <Autocomplete
                                ...
                                size="small"
                                options={categories}
                                defaultValue={eyebrowCategories}
                                onChange={(event,value) => {
                  ...
                  <FormControl fullWidth className={classes.field}>
                    <Query query={COSMETOLOGY_QUERY} className={classes.field}>
                      ...
                      return  <Autocomplete
                                ...
                                size="small"
                                options={categories}
                                defaultValue={cosmetologyCategories}
                                onChange={(event,value) => {                              
                  ...
                  <FormControl fullWidth className={classes.field}>
                    <Query query={AESTHETICS_QUERY} className={classes.field}>
                      ...
                      return  <Autocomplete
                                ...
                                size="small"
                                options={categories}
                                defaultValue={aestheticsCategories}
                                onChange={(event,value) => {
